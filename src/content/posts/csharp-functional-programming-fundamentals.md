...
|C#|Basic features covered in this chapter|Functional and relevant features covered in later chapters|Features out of scope|
|---|---|---|---|
|1.0|Class Structure, Interface, Enumeration, Attribute|Delegate, Event, Function member, ref parameter, out parameter, Parameter array, foreach statement|Inheritance, Pointer, Interop|
...
|4.0||Named argument, Optional argument, Generic covariance and contravariance|Dynamic type|
...
|7.3|ref local reassignment, stackalloc initializer, Attributes on backing fields|Expression variables in initializers and queries, Tuple comparison|Indexing movable fixed buffers, Custom fixed statement|
|8.0||using declaration, Static local function, switch expressin, pattern match, Asynchronous stream||
