...
[![image](https://aspblogs.z22.web.core.windows.net/dixin/Windows-Live-Writer/Setup-PHP-for-Visual-Studio-Code-on-Wind_12515/image_thumb_2.png)](https://aspblogs.z22.web.core.windows.net/dixin/Windows-Live-Writer/Setup-PHP-for-Visual-Studio-Code-on-Wind_12515/image_7.png)
...
[![image](https://aspblogs.z22.web.core.windows.net/dixin/Windows-Live-Writer/Setup-PHP-for-Visual-Studio-Code-on-Wind_12515/image_thumb_3.png)](https://aspblogs.z22.web.core.windows.net/dixin/Windows-Live-Writer/Setup-PHP-for-Visual-Studio-Code-on-Wind_12515/image_8.png)

## Setup Apache

Go to Apache website: [https://httpd.apache.org/docs/current/platform/windows.html#down](https://httpd.apache.org/docs/current/platform/windows.html#down), and download the Windows version, for example, httpd-2.4.25-win64-VC14.zip.
...
Go to XDebug website: [https://xdebug.org/download.php](https://xdebug.org/download.php), download the Windows version, for example, PHP 7.1 VC14 TS (64 bit) in this case.
...
[![image](https://aspblogs.z22.web.core.windows.net/dixin/Windows-Live-Writer/Setup-PHP-for-Visual-Studio-Code-on-Wind_12515/image_thumb_4.png)](https://aspblogs.z22.web.core.windows.net/dixin/Windows-Live-Writer/Setup-PHP-for-Visual-Studio-Code-on-Wind_12515/image_10.png)
