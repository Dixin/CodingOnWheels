...
-   Document: [https://CodingOnWheels.com/posts/EntityFramework.Functions](https://CodingOnWheels.com/posts/EntityFramework.Functions "https://CodingOnWheels.com/posts/EntityFramework.Functions")
...
-   [Examples](https://CodingOnWheels.com/posts/EntityFramework.Functions#Examples)
    ...
    -   [Scalar-valued function, non-composable](https://CodingOnWheels.com/posts/EntityFramework.Functions#Scalar-valued_function,_non-composable)
    -   [Scalar-valued function, composable](https://CodingOnWheels.com/posts/EntityFramework.Functions#Scalar-valued_function,_composable)
    -   [Aggregate function](https://CodingOnWheels.com/posts/EntityFramework.Functions#Aggregate_function)
    -   [Built-in function](https://CodingOnWheels.com/posts/EntityFramework.Functions#Built-in_function)
    -   [Niladic function](https://CodingOnWheels.com/posts/EntityFramework.Functions#Niladic_function)
    -   [Model defined function](https://CodingOnWheels.com/posts/EntityFramework.Functions#Model_defined_function)
-   [Version history](https://CodingOnWheels.com/posts/EntityFramework.Functions#Version_history)
